...
public class PostagemServices {
	 ...
	 * @param atualizadaPostagem - campos do objeto postagem passados pelo controller
	 * @return O método irá buscar se existe uma postagem com o ID passado, caso exista será atualizado os campos Texto e titulo da postagem, se não existir será retornado um optional vazio para o controller
	 */
